...
$L__BB0_24:
	...
	selp.f32 	%f288, %f111, %f112, %p29;

$L__BB0_27:
	add.f32 	%f113, %f288, %f288;
	setp.eq.f32 	%p31, %f16, 0f00000000;
	selp.f32 	%f114, 0f3F800000, 0f3F000000, %p31;
	fma.rn.f32 	%f291, %f114, %f113, 0f00000000;
...
$L__BB0_38:
	...
	selp.f32 	%f290, %f168, %f169, %p48;

$L__BB0_41:
	add.f32 	%f170, %f290, %f290;
	setp.eq.f32 	%p50, %f25, 0f00000000;
	selp.f32 	%f171, 0f3F800000, 0f3F000000, %p50;
	fma.rn.f32 	%f291, %f171, %f170, %f291;
...
$L__BB0_52:
	...
	selp.f32 	%f292, %f225, %f226, %p65;

$L__BB0_55:
	add.f32 	%f227, %f292, %f292;
	setp.eq.f32 	%p67, %f34, 0f00000000;
	selp.f32 	%f228, 0f3F800000, 0f3F000000, %p67;
	fma.rn.f32 	%f291, %f228, %f227, %f291;
